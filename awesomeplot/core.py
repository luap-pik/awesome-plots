...
class Plot(object):
    ...
    def __init__(self, output='paper', rc_spec={}, font_scale=1.1):
        ...
        discrete_colours_12 = ListedColormap(
            np.array(
                ['#adb0c2', '#ffb6c1', '#d065bb', '#670567', '#f47b39', '#c31717', '#831010', '#0a2a9a', '#4baad8',
                 '#a7f0a7', '#52ba32', '#2a721a']),
            'discrete_12'
        )
        ...
        self.linestyles = np.tile(['-', '--','-.'], 1 + discrete_colours_12.N // 3)[:discrete_colours_12.N]
